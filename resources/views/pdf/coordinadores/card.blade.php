                    ...
                    @foreach ($coordinador as $item)
                        <td>
                            <div class="card mr-1 ml-4 mb-1 fondo" style="width: 20rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <p class="form-control" style="width: 80%; font-size: 7px;">
                                            {{ Str::upper($item->nombres_coordinador . " " . $item->apellidos_coordinador) }}</p>
                                        <small class="form-text text-muted text-center mt-1"
                                ...
                                <div class="card-footer text-center text-white font-weight-bold" style="background-color: black; font-size: 14px;">
                                    COORDINADOR DE DELEGADOS/AS <br /> ANTE LA JUNTA RECEPTORA DEL VOTO
                                </div>
                            </div>
                        </td>
                    @endforeach
