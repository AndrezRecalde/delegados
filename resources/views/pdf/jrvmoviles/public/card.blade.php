                        ...
                        <td>
                            <div class="card mr-4 ml-4 mb-3 fondo" style="width: 20rem;">
                                ...
                                <div class="card-footer text-center font-weight-bold p-1"
                                    style="background-color: black; color: white; font-size: 12px;">
                                    DELEGADO/A <br /> CENTRO DE DIGITALIZACION DE ACTAS (CDA)
                                </div>
                    ...
                    @for ($j = 0; $j < 2; $j++)
                        <td>
                            <div class="card mt-4 mr-4 ml-4 mb-5 fondo_reverso" style="width: 20rem;">
                                <div class="card-body">
                                    <img src="{{ public_path('/images/posterior_cda.png') }}"
