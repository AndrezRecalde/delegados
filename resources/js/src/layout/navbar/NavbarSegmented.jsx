...
const mockdata = [
  { label: "Dashboard", icon: IconChartDonutFilled, links: [{ label: "Dashboard", link: "/dashboard" },] },
  {
    label: "Supervisores",
    icon: IconListCheck,
  ...
  },
  {
    ...
    initiallyOpened: true,
    links: [
      { label: "Ver delegados", link: "/veedores" },
      { label: "Exportar delegados", link: "/export/veedores" },
    ],
  },
  {
    label: "Escaneadores",
    ...
    >
      ...
      <Navbar.Section className={classes.footer}>
        <a
          ...
          onClick={startLogout}
        >
          <IconLogout className={classes.linkIcon} stroke={1.9} color="red" />
